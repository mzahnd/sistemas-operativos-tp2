...
void addCommand(commandList commandLinkedList, char * name, processMainFunction_t funtion){
  commandLinkedList->firstCommand = addCommandRec(commandLinkedList->firstCommand, name, fuction);
}

commandNode_t * addCommandRec(commandNode_t * aux, char * name, processMainFunction_t funtion) {
